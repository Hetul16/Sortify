...
public class InsertionSortMenu : MonoBehaviour
{

    public InsertionSortAlgo InsertionSort;
    public InsertionSortAlgo ActiveSorter;
    public InputField InputNumberOfCubes;

    public void StartSort()
    {
        ActiveSorter = Instantiate(InsertionSort);
